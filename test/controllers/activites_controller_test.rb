...
class ActivitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activite" do
    assert_difference('Activite.count') do
      post activites_url, params: { activite: { approved: @activite.approved, create_at: @activite.create_at, description: @activite.description, duration: @activite.duration, updated_at: @activite.updated_at, user_id: @activite.user_id } }
    end
  ...
  test "should update activite" do
    patch activite_url(@activite), params: { activite: { approved: @activite.approved, create_at: @activite.create_at, description: @activite.description, duration: @activite.duration, updated_at: @activite.updated_at, user_id: @activite.user_id } }
