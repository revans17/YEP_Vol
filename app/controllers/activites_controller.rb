class ActivitesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @activite.save
        format.html { redirect_to @activite, notice: 'Activity was successfully created.' }
  ...
  private
    ...
    def activite_params
      params.require(:activite).permit(:user_id, :duration, :description, :create_at, :updated_at, :approved)
    end
end
